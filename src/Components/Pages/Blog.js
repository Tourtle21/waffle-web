...
const Success = () => {
    ...
    return (
        <main>
            <Helmet>
                <title>Blog</title>
                <meta name="description" content="Want to learn more about custom web design services? Learn more abost pricing, timeframes, and find the best website builder for you." />
